...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        {{-- Create forum button (teachers only) --}}
        @if(auth()->user()->isTeacher())
        <a href="{{ route('forums.create') }}" 
           class="bg-pink-600 hover:bg-pink-700 text-white px-6 py-3 rounded-lg font-semibold shadow-md transition duration-200">
    ...
    <div class="space-y-4">
            ...
            <div class="p-6">
                <div class="flex items-start justify-between">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-gray-600 mb-3 ml-16">
                            {{ $forum->description }}
                        </p>
                        @endif
                    ...
                    <div class="flex gap-2 ml-4">
                        ...
                        {{-- Edit and delete buttons (forum owner only) --}}
                        ...
                        <!-- Delete forum form -->
                        <form action="{{ route('forums.destroy', $forum) }}" 
                              method="POST" 
                              class="inline"
                              onsubmit="return confirm('Are you sure you want to delete this forum? All posts will be deleted.');">
                            @csrf
                            @method('DELETE')
                            <button type="submit" 
                        ...
                        {{-- View button (active forums or teachers only) --}}
                ...
                <!-- Latest post preview -->
                @php
                    // Get the latest post with user data
        ...
        {{-- Empty state when no forums exist --}}
        @empty
        <div class="text-center py-12 bg-white rounded-lg shadow">
            ...
            @if(auth()->user()->isTeacher())
            <a href="{{ route('forums.create') }}" 
               class="text-pink-600 hover:text-pink-800 font-semibold mt-2 inline-block">
